...
class c_messagerie extends C_utilitaire {
  ...
  //Permet de trier tous les utilisateurs à qui on a parler du plus récent au plus ancien
        ...
        $data['$personne'] = array(
            ...
            $data['conv1'] = $this->m_messagerie->get_message_profil_envoyeur($data['userId'],$data['$personne']['id']);
            $data['conv2'] = $this->m_messagerie->get_message_profil_envoyeur1($data['userId'],$data['$personne']['id']);
