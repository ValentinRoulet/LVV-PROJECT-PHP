        ...
        if ($script == 'datatables') {
            ...
            <script>
                ...
                */
                ...
                //ex de bouton dans le fichier  : <button class="btn btn-default" id="bouton_cherche" value="11">Présents</button>
...
firstDay: 1
    ...
    // ----------------------------------------------------------------------------------------//
    if ($script == 'jexcel') {
        echo "<script src='" . base_url('/assets/plugins/jexcel/jexcel.js') . "'> </script>";
