...
text:function(a){return a.i18n("buttons.copy","Copier")},action:function(a,b,d,c){q(c);a=B(b,c).str;a=h("<span>"+b.i18n("buttons.copyKeys","Appuyer sur <i>ctrl</i> + <i>C</i> pour copier le tableau<br>dans le presse papier.<br><br>Pour annuler, cliquer ici ou appuyer sur Echap.")+"</span>").append(h("<div/>").css({height:1,width:1,overflow:"hidden"}).append(h("<textarea readonly/>").val(a)));b.buttons.info(b.i18n("buttons.copyTitle","Copier"),a,0);a.find("textarea")[0].focus();a.find("textarea")[0].select();
