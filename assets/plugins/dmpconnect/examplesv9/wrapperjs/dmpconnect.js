...
DMPConnect.prototype.hl_openSession = function(timeoutInSeconds, optionalParameters, resultCallback)
{
    ...
    {        
        ...
        // GetDcparameter
        if( optionalParameters.i_getDcparamInformations !== undefined )
        {
            command.i_getDcparamInformations = optionalParameters.i_getDcparamInformations;
        }

            if( optionalParameters.s_tseCredentials !== undefined )    {        command.s_tseCredentials = optionalParameters.s_tseCredentials;    }    
    }
...
/**
  ...
  */
DMPConnect.prototype.hl_startRemoteControl = function( command , resultCallback)
{
    command               = command || {};
...
/**
  ...
  * }
  */
DMPConnect.prototype.hl_remoteControlStatus = function( command, resultCallback )
{
    command               = command || {} ;
...
/**
  ...
  *  
  */
DMPConnect.prototype.hl_startRemoteControlInMonitoring = function( resultCallback )
{
    var command = 
    {
 ...
 */
DMPConnect.prototype.hl_sendRemoteInAnswer = function( answerObject, resultCallback )
{
    var command = 
    {
...
/**
  ...
  * }
  */
DMPConnect.prototype.hl_exportDocumentToRemoteOut = function( aDocumentHandle, resultCallback )
{
    var command = 
    {
...
/**
  ...
  * }
  */
DMPConnect.prototype.hl_exportDocumentToRemoteOutByUniqueId = function( anIns, aDocumentUniqueId, aDocumentUuid, resultCallback )
{
    var command = 
    {
        "s_ins"              : anIns,
...
/**
  ...
  * }
  */
DMPConnect.prototype.hl_notifyPsConnectedToRemoteOut = function( resultCallback )
{
    var command = 
    {
...
/**
  ...
  */
DMPConnect.prototype.hl_getUpdatedTypeCode = function( typeCode, resultCallback )
{
    command = {};
