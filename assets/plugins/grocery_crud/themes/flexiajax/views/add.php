<?php
    ...
    $this->set_js($this->default_theme_path.'/flexiajax/js/flexigrid-add.js');
?>
...
<div class="flexigrid crud-form" style='width: 100%;'>
    ...
    <div id='main-table-box'>
        <?php echo form_open( $insert_url.'/'.$unic_id, 'method="post"" id="crudForm"" autocomplete="off" enctype="multipart/form-data"'); ?>
        <div class='form-div'>
            <?php
            $counter = 0;
