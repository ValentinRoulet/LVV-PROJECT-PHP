<table cellpadding="0" cellspacing="0" border="0" class="display groceryCrudTable datatable" id="datatable">
	<thead>
		<tr>
	...
	<tfoot>
		<tr>
                        ...
                        -->
                            <input type="text" name="<?php echo $column->field_name; ?>" placeholder="<?php echo $this->l('list_search').' '.$column->display_as; ?>" class="search_<?php echo $column->field_name; ?>" />
                        </th>
			<?php }?>
			<?php if(!$unset_delete || !$unset_edit || !$unset_read || !empty($actions)){?>
				<th>
