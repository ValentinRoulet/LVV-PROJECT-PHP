...
<div class="crud-form" data-unique-hash="<?php echo $unique_hash; ?>">
    <div class="container gc-container">
		<div class="row">
        	<div class="col-md-12">
				<?php echo form_open( $update_url, 'method="post" id="crudForm" enctype="multipart/form-data" class="form form-horizontal"'); ?>
					...
					<div class="form-group">
						<div class="col-sm-offset-3 col-sm-7">
							...
							if(isset($this->edit_custom_redirection)) { ?>
								<a href="<?php echo $this->edit_custom_redirection;?>">
